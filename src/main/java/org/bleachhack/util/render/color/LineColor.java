...
public class LineColor extends RenderColor implements Cloneable {
	...
	private GetColorFunc getColorFunc;
	...
	private LineColor(GetColorFunc getColorFunc) {
	...
	@FunctionalInterface
	private static interface GetColorFunc {
		
		public int[] apply(float f1, float f2, float f3, int i);
	}
