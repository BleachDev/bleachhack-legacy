...
public class WindowScrollbarWidget extends WindowWidget {
	...
	public void render(int windowX, int windowY, int mouseX, int mouseY) {
		...
		if (pos != null) {
			...
			Window.fill(pos[0], pos[1], pos[0] + pos[2], pos[1] + pos[3], color);

			int middleY = pos[1] + (int) (pos[3] / 2d);

			DrawableHelper.fill(pos[0] + 3, middleY - 3, pos[0] + 7, middleY - 2, 0xff7060ff);
			DrawableHelper.fill(pos[0] + 3, middleY, pos[0] + 7, middleY + 1, 0xff7060ff);
			DrawableHelper.fill(pos[0] + 3, middleY + 3, pos[0] + 7, middleY + 4, 0xff7060ff);
